    ...
    <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8">
      <div className="sm:flex sm:items-center sm:px-5 justify-between">
        <div>
          <a
            href="#"
            className="block w-80 h-80 p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100"
          >
        ...
        <div className="px-8">
          ...
          >
            ...
            <p className="font-normal text-gray-700 dark:text-gray-400">
              웹 빌드, 촬영, 가공 및 편집으로 가상공간을 제작하여 기업의 브랜드
        ...
        <div>
          <a
            href="#"
            class="block w-80 h-80 p-6 bg-white border rounded-lg hover:bg-gray-100"
          >
